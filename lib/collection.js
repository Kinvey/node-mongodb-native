...
var checkCollectionName = require('./utils').checkCollectionName
  , ObjectID = require('@progresskinvey/mongodb-core').BSON.ObjectID
  , Long = require('@progresskinvey/mongodb-core').BSON.Long
  , Code = require('@progresskinvey/mongodb-core').BSON.Code
  , f = require('util').format
  , AggregationCursor = require('./aggregation_cursor')
  , MongoError = require('@progresskinvey/mongodb-core').MongoError
  ...
  , CoreReadPreference = require('@progresskinvey/mongodb-core').ReadPreference
...
var group = function(self, keys, condition, initial, reduce, finalize, command, options, callback) {
  ...
  if(command) {
    ...
    self.s.db.command(selector, options, function(err, result) {
      if(err) return handleCallback(callback, err, null);
      // ref: https://github.com/mongodb/node-mongodb-native/commit/5c1fb015449d619f916220d99e11cb348a055e63
...
var mapReduce = function(self, map, reduce, options, callback) {
  ...
  self.s.db.command(mapCommandHash, {readPreference:options.readPreference, raw: options.raw}, function (err, result) {
    if(err) return handleCallback(callback, err);
    // In raw mode let the caller decode the raw mongo result, to support inline bson
    // ref: https://github.com/andrasq/node-mongodb-native/commit/5b9f7a44eeb4790e1a49f9bf98273b2c3fb9d091
